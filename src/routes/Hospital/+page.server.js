...
export const actions = {
  default: async ({ request }) => {
    ...
    let url = "http://training.us-hpccsystems-dev.azure.lnrsg.io:8002/WsEcl/json/query/roxie/hospitals_svc.15";
    let body = {
      "hospitals_svc.15": {
        "cityval": city,
        "fipsval": fips,
    ...
    return jsonResponse["hospitals_svc.15Response"].Results;
  },
};